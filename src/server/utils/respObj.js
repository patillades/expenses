...
/**
 * Get a not found response with the given message
 *
 * @param {string} msg
 * @returns {RespObj}
 */
function getNotFoundResp(msg) {
  return getRespObj(404, msg);
}
...
module.exports = { getBadReqResp, getUnauthorizedResp, getNotFoundResp, getInternalErrResp };
